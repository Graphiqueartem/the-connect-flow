  ...
  return (
    <div className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="relative bg-[#FF6B8A] overflow-hidden pb-20">
        ...
        {/* Yellow Progress Line along left curve edge */}
        <div className="absolute bottom-0 left-0 w-full h-24 z-10 pointer-events-none overflow-hidden">
          <svg className="w-full h-full" viewBox="0 0 1200 120" preserveAspectRatio="none">
            ...
            <path 
              d={`M0,120 Q${600 * progressPercentage / 100},20 ${1200 * progressPercentage / 100},120`}
              fill="none" 
